  ...
  return (
    <div>
      <section className="text-center py-10 px-4 bg-[#31065A]"id="Home">
        ...
        <h1 className="text-4xl font-bold text-orange-500">Hi, It's me</h1>
        <h2 className="text-5xl font-bold mt-2">Zubair Ahmed</h2>
        <p className="text-xl mt-2">
          And I'm a <span className="text-orange-500">Frontend Developer</span>
        </p>
        ...
        <img
          src="img2.png"
          alt="Illustration of a developer working on a laptop with code and technology icons"
